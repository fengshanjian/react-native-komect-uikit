 ...
 * @Last modified time: 2017-08-15T15:54:50+08:00
 */
...
export default class extends Component {
  ...
  _renderText(value){
    if(this.props.activeText&&value){
      return(
        <Text style={[{
          position:'absolute',
          left:5,
          ...
          width:30,
          textAlign:"left",
          backgroundColor:'transparent'},this.props.activeTextStyle]}>
          {this.props.activeText}
        </Text>
      )
    }
    else if(this.props.inactiveText&&!value){
      return(
        <Text style={[{
          position:'absolute',
          right:5,
          ...
          width:30,
          textAlign:"right",
          backgroundColor:'transparent'},this.props.inactiveTextStyle]}>
